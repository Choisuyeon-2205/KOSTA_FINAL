...
public class SecurityConfig extends WebSecurityConfigurerAdapter  {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests() // HttpServletRequest에 따라 접근(access)을 제한
			...
			.antMatchers("/main/**","/fragments/**","/center/**","/webfonts/**","/login/**","/exerciseinfoboard/**","/dietdiaryboard/**","/healthboard/**","/sharingboard/**","/naversearch/**","/auth/**", "/upload/**","/business/**", "/body/**").permitAll() //   누구나 접근 허용
