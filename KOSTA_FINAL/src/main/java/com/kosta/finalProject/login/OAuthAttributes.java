...
public class OAuthAttributes {
    ...
    public UserVO toEntity(){
        return UserVO.builder().userName(name).userEmail(email).userPhoto(picture).urole(UserRoleEnumType.USER).social(SocialLoginType.valueOf(registrationId.toUpperCase())).build();
    }
}