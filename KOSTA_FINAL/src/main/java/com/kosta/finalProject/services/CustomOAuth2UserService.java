...
import com.kosta.finalProject.login.OAuthAttributes;
import com.kosta.finalProject.login.SessionUser;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User>{
    ...
    private UserVO saveOrUpdate(OAuthAttributes attributes) {
        UserVO user = urepo.findByUserName(attributes.getEmail())
